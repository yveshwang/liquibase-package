# Thanks to Nathan Voxland <nathan@voxland.net>
# For the original liquibase.spec file. You can find it here - https://github.com/liquibase/liquibase/blob/e0badd697d82a87ba868b41e68b659cf8c8e68e8/liquibase-core/src/main/resources/dist/liquibase.spec
#
# y.h. 21.09.2016
#
...
%{__install} -m 0644 -D -p %{name}.jar %{buildroot}%{_libdir}/%{name}
